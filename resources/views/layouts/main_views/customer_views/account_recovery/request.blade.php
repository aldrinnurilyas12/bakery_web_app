...
@section('content')
    ...
    <div style="display: flex; justify-content: left;font-weight: bold;" class="d-flex-center">
        <h2 style="font-weight: bold;font-size: 20px;">Pemulihan Akun Pengguna</h2>
    </div>
    ...
    <form id="formGeneral" method="POST" action="{{ route('check-email-otp') }}">
        ...
        <input type="text" name="account_recovery" value="Y" hidden>

        <button id="btnGeneral" type="submit" class="btn-general"><span class="btn-text">Kirim Pemulihan Akun</span>
