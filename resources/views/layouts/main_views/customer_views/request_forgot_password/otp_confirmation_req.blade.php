...
@section('content')
    ...
    <form id="formGeneral" method="POST" action="{{ route('otp-proccess-request') }}">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" name="otp" value="{{ old('otp') }}" placeholder="Masukan kode OTP"
                autocomplete="off">
            <x-input-error :messages="$errors->get('otp')" class="text-danger" />
        </div>
