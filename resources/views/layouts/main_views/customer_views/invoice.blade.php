        ...
        <div class="main-container">
            ...
            <div class="container">
                                        ...
                                        @if ($invoice->name && $invoice->email)
                                            <div class="col-xl-8">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li><span class="fw-bold">Pelanggan :</span>
                                        ...
                                        <div class="col-xl-3">
                                            <ul style="color: black;" class="list-unstyled">
                                                ...
                                                @if ($invoice->voucher_code_used)
                                                    @if ($invoice->discount)
                                                        <li class="text-muted ms-3"><span
                                                                class="text-black me-4">Potongan:</span>
                                                            <br><span class="text-danger">{{ $invoice->discount }} %
                                                            </span>
                                                        </li>
                                                    @else
                                                        <li class="text-muted ms-3"><span
                                                ...
                                                @if ($invoice->total_amount)
                                                    <li class="text-muted ms-3"><span
                                                            class="text-black me-4">Subtotal:</span>
                ...
                <li class="text-muted ms-3"><span class="text-black me-4">Kembalian:</span> <br>{{"Rp." . number_format($invoice->payment_changes)}}</li> --}}
                                                <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Pay
                                                        Method:</span>
                                                    <br>
                                            ...
                                            <p class="text-black float-start"><span class="text-black me-3"> Grand
                                                    Total</span><span style="font-size: 25px; font-weight:bold;"><br>
