                    ...
                    @if ($rewards->isNotEmpty())
                        @foreach ($rewards as $reward)
                            <div style="display: flex; gap:20px;" class="image-content">
                                <img width="90" height="90" src="{{ url('storage/' . $reward->images) }}"
                                    alt="">

                                <div style="display: block;" class="grand-total">
                                    <div class="group-menu-date">
                                        <p style="font-size: 1.25rem;color:rgb(0, 0, 0);" class="text-date">
                                            {{ $reward->rewards_name }}
                                        </p>
                                    </div>
                        ...
                        @endforeach
                    @else
                        <p style="text-align: center;margin:0 auto;">Tidak ada rewards yang anda klaim.</p>
                    @endif
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"
                        ...
                        <ul>
                            ...
                            <li>Status Unclaimed artinya Reward belum diambil oleh pelanggan dan status Claimed artinya
