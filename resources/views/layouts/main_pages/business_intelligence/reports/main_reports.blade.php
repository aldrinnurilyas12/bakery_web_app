                        ...
                        <div style="display: flex; justify-content:space-between;" class="card-header">
                            ...
                            <div class="filter-reports">
                                <form action="{{ route('generate_reports') }}" method="GET">
                                    <div class="date" style="display: flex; flex-wrap: wrap; justify-content: center; gap:20px;">
                                            <div class="start-date">
                                                <label for=""><strong>Tanggal awal</strong></label>
                                                <input class="form-control" type="date"  value="{{ old('start_date', request('start_date')) }}" name="start_date" required>
                                            </div>
                                            <div class="start-date">
                                                <label for=""><strong>Tanggal akhir</strong></label>
                                                <input class="form-control" type="date"   value="{{ old('end_date', request('end_date')) }}" name="end_date" required>
                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(request('start_date'))
                                                            ...
                                                            <a href="{{ route('download_transaction_report', [
                                                                'start_date' => request('start_date'),
                                                                'end_date' => request('end_date'),
                                                                'store' => request('store')
                                                            ]) }}"><i class="fa fa-download"></i> Unduh Laporan </a>
                                                            @else
                                                                Tidak ada data
                                                            @endif
                                                        @endif
                                                    ...
                                                    <td>
                                                         @if(request('start_date'))
                                                            ...
                                                            <a href="{{ route('download_products_daily_report', [
                                                                'start_date' => request('start_date'),
                                                                'end_date' => request('end_date'),
                                                                'store' => request('store')
                                                            ]) }}"><i class="fa fa-download"></i> Unduh Laporan </a>
                                                     ...
                                                     <td>
                                                        @if(request('start_date'))
                                                            ...
                                                            <a href="{{ route('download_production_product_report', [
                                                                'start_date' => request('start_date'),
                                                                'end_date' => request('end_date')
                                                            ]) }}"><i class="fa fa-download"></i> Unduh Laporan </a>
                                                            @else
                                                    ...
                                                    <td>
                                                        @if(request('start_date'))
                                                            ...
                                                            <a href="{{ route('download_distribution_report', [
                                                                'start_date' => request('start_date'),
                                                                'end_date' => request('end_date')
                                                            ]) }}"><i class="fa fa-download"></i> Unduh Laporan </a>
                                                            @else
