                    ...
                    <div class="card mb-4">
                        ...
                        <div style="display: flex; justify-content:space-between;" class="card-header">
                            <div class="content-header">
                                <h4>Dokumentasi Modul: <span
                                        style="font-weight: bold;text-decoration: underline;">{{ $module_documentation->module_name }}</span>
                                </h4>
                                <p style="margin-bottom:0;">Ditambahkan: {{ $module_documentation->created_at }}</p>
                                @if ($module_documentation->updated_at)
                                    <p>Diperbarui: {{ $module_documentation->updated_at }}</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            @if ($module_documentation)
                                <div class="modal-body">
                                    <iframe src="{{ asset('storage/' . $module_documentation->attachment_file) }}"
