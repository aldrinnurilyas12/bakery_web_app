...
<head>
    ...
    <title>Kencana Bakery - Master Data Kategori Supplier</title>
                                ...
                                @if (!$user_permission_forbidden)
                                    <div style="display: flex; gap:10px;" class="flex-btn">
                                        <div class="button-add-product">
                                            <a class="btn btn-warning" href="{{ route('supplier.index') }}">Data
                                                Supplier
                                            </a>
                                        </div>
                                        <div class="button-add-product">
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            ?>
                                            @foreach ($supplier_category as $sup)
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    @if (!$user_permission_forbidden)
                                                        <td>
                                                            <div style="display: flex;gap:10px;" class="btn-action">
                                                                ...
                                                                <a
                                                                    href="{{ route('category_supplier_update', $sup->id) }}"><i
                                    ...
                                    <div style="display: flex;" class="empty-content">
                                        <div style="display: flex; gap:20px;margin:auto;" class="alert-info">
                                            ...
                                            <div style="display: block;" class="text-content">
                                                <h3>Belum ada data Kategori Supplier</h3>
                                                @if (!$user_permission_forbidden)
                                                    <a class="btn btn-primary"
                                                        href="{{ route('category_supplier_create') }}">Tambah data
                                                        Kategori Supplier</a>
                                                @endif
                                            </div>
                                        </div>
