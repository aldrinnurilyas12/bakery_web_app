        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h4>Ubah Data Supplier Kategori</h4>
                    <form id="formGeneralMaster" action="{{ route('category_supplier_edit', $supplier_category->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" class="form-control"
                                value="{{ $supplier_category->category_name }}" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $supplier_category->updated_at ?: '-' }}" readonly>
                        </div>
