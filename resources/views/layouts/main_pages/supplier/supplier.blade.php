...
<head>
    ...
    <title>Kencana Bakery - Master Data Supplier</title>
                                ...
                                @if (!$user_permission_forbidden)
                                    <div style="display: flex; gap:10px;" class="flex-btn">
                                        <div class="button-add-product">
                                            <a class="btn btn-warning" href="{{ route('supplier_category') }}">Kategori
                                                Supplier</a>
                                        </div>
                                        <div class="button-add-product">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($supplier as $sup)
                                                <tr>
                                                    ...
                                                    @if (!$user_permission_forbidden)
                                                        <td>
                                                            <div style="display: flex;gap:10px;" class="btn-action">
                                                                ...
                                                                <a
                                                                    href="{{ route('supplier_update', $sup->supplier_code) }}"><i
                                                                        class="fas fa-edit"></i></a>

                                                                {{-- <a href="#" data-toggle="modal"
                                                                    data-target="#deleteModal{{ $sup->id }}"><i
                                                    ...
                                                    <td>{{ $sup->pic }}</td>
                                                    <td>
                                                        @if ($sup->status_name == 'Active')
                                                            <span class="text-success">{{ $sup->status_name }}</span>
                                                        @else
                                                            <span class="text-danger">{{ $sup->status_name }}</span>
                                                        @endif
                                                    </td>
                                            ...
                                            <div style="display: block;" class="text-content">
                                                ...
                                                @if (!$user_permission_forbidden)
                                                    <a class="btn btn-primary"
                                                        href="{{ route('supplier_create') }}">Tambah data Supplier</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
