            ...
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    @foreach ($discounts as $discount)
                        <form action="{{ route('edit_discount', $discount->id) }}" method="POST"
