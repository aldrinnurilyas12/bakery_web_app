...
<head>
    ...
    <title>Kencana Bakery - Tambah Discount</title>
                    ...
                    <form action="{{ route('discount.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="discount_name" class="form-control"
                                value="{{ old('discount_name') }}" placeholder="Masukan nama diskon" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="discount_code" class="form-control"
                                value="{{ old('discount_code') }}" placeholder="Masukan kode diskon" autocomplete="off">
                            <div class="alert alert-warning">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="discount_total" class="form-control"
                                value="{{ old('discount_total') }}" placeholder="Masukan total diskon"
                                autocomplete="off">
                            <div class="alert alert-warning">
