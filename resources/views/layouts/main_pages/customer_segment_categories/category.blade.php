...
<head>
    ...
    <title>Kencana Bakery - Master Data Kategori Segment Pelanggan</title>
                                    ...
                                    <table class="table" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                @endif --}}
                                                <th>Nama Segment</th>
                                                <th>Min Freq Transaksi</th>
                                                <th>Max Freq Transaksi</th>
                                                <th>Min Belanja</th>
                                                <th>Max Belanja</th>
                                                <th>Recency (Time)</th>
                                                <th>Warna</th>
                                            ...
                                            <div style="display: block;" class="text-content">
                                                ...
                                                @if (!$user_permission_forbidden)
                                                    <a class="btn btn-primary"
                                                        href="{{ route('customer_segment_create') }}">Tambah
                                                        Kategori</a>
                                                @endif
                                            </div>
                                        </div>
