...
@section('content')
    ...
    <form id="formGeneral" method="POST" action="{{ route('password-auth-proccess') }}">
        @csrf
        ...
        <button id="btnGeneral" type="submit" class="btn-general"><span class="btn-text">Kirim Kode OTP</span>
