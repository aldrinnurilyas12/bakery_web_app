                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div style="font-size: 13px;" class="alert alert-info">
                            <ul>
                                <li>Harga HPP hanya bisa aktif satu saja, jika ingin menambah data Bill of Material baru maka ubah status
                                </li>
                            </ul>
                        </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                         @if($bom->status == 7)
                                                                            ...
                                                                            data-target="#showStatus{{ $bom->ingredients_code }}"><i class="fa fa-edit"></i></a></td>
                                                                        @else
                                                                        <span>-</span>
                                                                        @endif
                                                                    <td>
                                                                        <a href="{{ route('bill-of-material-detail', $bom->ingredients_code) }}"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Ubah status BoM => {{ $bom->ingredients_code }}</h5>
                    ...
                    <div class="modal-body">
                        <form class="form-delete" action="{{ route('update_status_bom', $bom->ingredients_code) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input name="ingredients_code" type="text" class="form-control" value="{{ $bom->ingredients_code }}" readonly>
                            </div>
