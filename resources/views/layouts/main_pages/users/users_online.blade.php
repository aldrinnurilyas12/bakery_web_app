...
<head>
    ...
    <title>Kencana Bakery - Master Data Online Users</title>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div style="display: flex; justify-content:space-between;" class="card-header">
                            ...
                            <div class="title">
                                Master Data > <strong> Online Users </strong>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($users_data as $user)
                                                <tr>
                                                    ...
                                                    <td>{{ $user->name }}</td>
                                                    <td>
                                                        @if (in_array($user->id, $users_online))
                                                            <span class="text-success">
                                                                <span class="green-dot"></span> Sedang aktif
                                                            </span>
                                                        @else
