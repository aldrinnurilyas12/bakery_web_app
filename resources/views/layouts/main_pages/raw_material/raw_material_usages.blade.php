...
<head>
    ...
    <title>Kencana Bakery - Master Data Penggunaan Bahan Baku</title>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div style="display: flex; justify-content:space-between;" class="card-header">
                            ...
                            <div class="title">
                                Master Data / Penggunaan Bahan Baku
                            </div>
                                    ...
                                    <table class="table" id="dataTable" width="100%" cellspacing="0" wire:ignore>
                                        ...
                                        <tbody>
                                            @php
                                                $no = 1;
                                            @endphp
                                            @foreach ($material_usages as $raw)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
