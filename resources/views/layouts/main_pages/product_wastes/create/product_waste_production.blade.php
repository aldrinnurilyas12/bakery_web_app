            ...
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <form id="formGeneralMaster"
                        action="{{ route('production_waste_save', $production->production_detail_id) }}" method="POST"
                        ...
                        <hr class="menu">
                        <div class="category">
                            <input hidden class="form-control" type="text" value="{{ $production->production_code }}"
                                name="production_code" readonly>
                            <input hidden class="form-control" type="text"
                                value="{{ $production->production_detail_id }}" name="production_detail_id" readonly>
                            ...
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                {{ $production->production_detail_id }}
                                            </td>
                                            <td>
                        ...
                        <div class="form-group">
                            ...
                            <input id="rejectTotal" type="number"
                                value="{{ $production->qty_target_total - $production->actual_quantity }}"
                                min="0" name="reject_quantity" class="form-control" readonly required>
                        </div>
